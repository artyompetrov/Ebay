...
namespace Ebay.Server.Data.Migrations
{
    ...
    [Migration("20240407094223_ChangeWeightDefaultValue")]
    partial class ChangeWeightDefaultValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ebay.Server.Data.Models.ClientError", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ebay.Server.Data.Models.Currency", b =>
                {
            ...
            modelBuilder.Entity("Ebay.Server.Data.Models.IgnoredLot", b =>
                {
            ...
            modelBuilder.Entity("Ebay.Server.Data.Models.SearchQuery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ebay.Server.Data.Models.Lot", b =>
                {
                    b.HasOne("Ebay.Server.Data.Models.Currency", "Currency")
                        .WithMany()
