...
SET ""Categories"" = (case 
	...
	when ""ManualCondition"" = 'dismantledAndMatched' then hstore(array['condition','test_state'], array['used', 'matched']::text[])
	when ""ManualCondition"" = 'dismantledAndTested' then hstore(array['condition','test_state'], array['used', 'tested']::text[])
	when ""ManualCondition"" = 'dismantledNotTested' then hstore(array['condition','test_state'], array['used', 'notTested']::text[])
