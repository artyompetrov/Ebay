...
class PurchaseInfo(BaseModel):
    ...
    PurchaseInfo
    """ # noqa: E501
    price: Optional[Union[Annotated[float, Field(strict=True, ge=0.01)], Annotated[int, Field(strict=True, ge=1)]]] = None
    quantity: Annotated[int, Field(strict=True, ge=1)]
    var_date: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="date")
    __properties: ClassVar[List[str]] = ["price", "quantity", "date"]
