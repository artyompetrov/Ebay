    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.searchQueries)) {
            ...
            for (let item of this.searchQueries)
                data["SearchQueries"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.ruSearchQueries)) {
            data["RuSearchQueries"] = [];
            for (let item of this.ruSearchQueries)
                data["RuSearchQueries"].push(item ? item.toJSON() : <any>undefined);
        }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.purchaseHistory)) {
            ...
            for (let item of this.purchaseHistory)
                data["purchaseHistory"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.extractedData)) {
            ...
            for (let item of this.extractedData)
                data["extractedData"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.extractorInfo)) {
            ...
            for (let item of this.extractorInfo)
                data["extractorInfo"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.rates)) {
            ...
            for (let item of this.rates)
                data["rates"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
