...
/// <inheritdoc />
public partial class AddWriteModelOutboxAndAuditBackfill : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql(
            sql: """
                 UPDATE wm."LotForSales"
                 SET "CreatedAt" = TIMESTAMPTZ '2026-02-23 09:57:34+00',
                     "ChangedAt" = TIMESTAMPTZ '2026-02-23 09:57:34+00'
                 WHERE "CreatedAt" = TIMESTAMPTZ '0001-01-01 00:00:00+00'
                    OR "ChangedAt" = TIMESTAMPTZ '0001-01-01 00:00:00+00';
                 """);
