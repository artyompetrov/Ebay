...
function handleSubmit(event, client) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield client.upsertLotInfo(EbayClient_1.LotInfo.fromJS(data), data.get('productId').toString());
        }
        catch (error) {
