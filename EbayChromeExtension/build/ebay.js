...
function hasShippingToCountry(nextCountry, shipsTo, excludes) {
...
function fillShipping() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (shippingRatesAvailable) {
            ...
            yield changeShippingCountry(currentCountryIndex, shippingDiv, null);
            return;
        }
    });
}
