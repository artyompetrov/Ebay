...
function getDataFromPage(client) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield fillSeller();
        yield fillCondition();
        yield fillConditionDescription();
        yield fillLocatedIn();
        fillShipping();
        ...
        yield compareLotInfos(serverLotInfo);
    });
}
...
function getAuthorizeFetch(oAuth2Client) {
    return new FetchWrapperCustom_1.FetchWrapperCustom({
        ...
        getNewToken: () => __awaiter(this, void 0, void 0, function* () {
            yield chrome.storage.local.set({ return_to_page: document.location.href });
...
function authPage(oAuth2Client) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (url.searchParams.has("code")) {
            ...
            yield chrome.storage.local.set({ return_to_page: null });
