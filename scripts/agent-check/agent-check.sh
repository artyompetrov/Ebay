...
run_step "Install Chromium for behavioral UI tests" bash -lc "node '$ROOT_DIR/src/Ebay/Tests.Frontend/bin/Debug/net10.0/.playwright/package/cli.js' install chromium"
