...
# Работай только если удается успешно сбилдать проект
Перед началом кодирования проверяй что у тебя билдается как C# проект так и Chrome расширение.
Если у тебя проект не билдается - не надо писать код в слепую, придется мне потом за тобой подчищать.
Если проект не билдается предоставь подробную информацию почему и советы по устранению проблемы билда, код писать в случае неуспешного билда не надо.