...
Перед началом работы изучите `.editorconfig` в корне репозитория, чтобы понимать, какие параметры форматирования и отступов должны использоваться по умолчанию.
